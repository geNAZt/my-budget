...
<div class="relative w-full h-full min-h-[450px] rounded-xl overflow-hidden border border-slate-200 shadow-inner" style="background-color: #272822;">
    ...
    {#if fetchingDeps}
        <div class="absolute top-3 right-3 z-10 flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-slate-900/90 border border-indigo-500/20 text-indigo-400 text-[10px] font-medium animate-pulse">
