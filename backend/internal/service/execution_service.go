...
import (
	...
	executionpb "github.com/genazt/my-budget-script/backend/internal/service/proto"
...
func (s *ExecutionService) StartRunner() {
	for {
		...
		if _, err := os.Stat(dir); os.IsNotExist(err) {
			...
			} else if _, err := os.Stat("backend/execution_engine"); err == nil {
				dir = "backend/execution_engine"
