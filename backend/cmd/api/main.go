...
import (
	...
	"github.com/genazt/my-budget-script/backend/internal/api/handler"
	...
	eb_provider "github.com/genazt/my-budget-script/backend/internal/integration/enablebanking"
	gc_provider "github.com/genazt/my-budget-script/backend/internal/integration/gocardless"
	t212_provider "github.com/genazt/my-budget-script/backend/internal/integration/trading212"
...
func main() {
	...
	systemAPI := handler.NewSystem(webSocketHandler, logService, dockerService, syncService, database)
