...
<!-- Expense Modal Details -->
{#if showExpenseModal && selectedExpenseObj}
    <div class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[999] flex items-center justify-center p-4" transition:fade>
        <div class="bg-white dark:bg-slate-900 w-full max-w-lg rounded-3xl shadow-2xl border border-slate-100 dark:border-slate-800 overflow-hidden flex flex-col max-h-[90vh]">
            <div class="p-6 bg-slate-50 dark:bg-slate-900/50 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center">
                <div class="flex items-center gap-2">
                    ...
                    <h3 class="text-lg font-black text-slate-900 dark:text-slate-100 uppercase tracking-tight">
                        {selectedExpenseObj.id ? "Configure Expense Node" : "Create Expense Node"}
                    </h3>
                </div>
                <button onclick={() => showExpenseModal = false} class="text-slate-400 hover:text-slate-600 p-1">
                    <X class="w-5 h-5" />
                </button>
            </div>
            ...
            <div class="flex border-b border-slate-100 dark:border-slate-800">
                <button
                    ...
                    class="flex-1 py-3 text-center text-xs font-black uppercase tracking-wider border-b-2
                        {modalMode === 'edit' ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-slate-400 hover:text-slate-600'}"
                >
                    Reschedule &amp; Settings
                </button>
                <button
                    ...
                    class="flex-1 py-3 text-center text-xs font-black uppercase tracking-wider border-b-2 flex items-center justify-center gap-1.5
                        {modalMode === 'funding' ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-slate-400 hover:text-slate-600'}"
            ...
            <div class="p-6 overflow-y-auto space-y-6 flex-1">
                {#if modalMode === 'edit'}
                    <div class="space-y-4">
                        <div class="space-y-1">
                            <span class="text-[10px] font-black uppercase tracking-wider text-slate-400 block">Expense Node Name</span>
                            <input
                                type="text"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-1">
                                <span class="text-[10px] font-black uppercase tracking-wider text-slate-400 block">Payment Cost</span>
                                <input
                                    type="number"
                            ...
                            <div class="space-y-1">
                                <span class="text-[10px] font-black uppercase tracking-wider text-slate-400 block">Due Period</span>
                                <div class="text-sm font-bold text-slate-800 dark:text-slate-200 bg-slate-50 dark:bg-slate-800 px-4 py-3 rounded-2xl border dark:border-slate-700 h-[46px] flex items-center">
                        ...
                        <div class="space-y-1.5">
                            <span class="text-[10px] font-black uppercase tracking-wider text-slate-400 block">Select Target Month</span>
                            <select
                        ...
                        <div class="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 mt-4">
                            ...
                            <button
                                ...
                                class="px-4 py-2 font-black text-[10px] uppercase tracking-wider rounded-xl transition-all flex items-center gap-1.5 shadow-sm
                                    {isFlexExpenseState 
                                        ...
                                        : 'bg-white hover:bg-slate-50 border text-slate-600 dark:bg-slate-700 dark:text-slate-200 dark:border-slate-600'}"
                            >
                                {#if isFlexExpenseState}
                        ...
                        <div class="space-y-3 pt-4 border-t border-slate-100 dark:border-slate-800">
                            <div class="flex justify-between items-center">
                                ...
                                <button
                                    ...
                                    class="text-indigo-650 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300 text-xs font-black uppercase tracking-wider flex items-center gap-1 transition-all active:scale-95 cursor-pointer"
                                >
                            ...
                            {#if !selectedExpenseObj.activeVersion?.subExpenses || selectedExpenseObj.activeVersion.subExpenses.length === 0}
                                <div class="p-4 bg-slate-50/50 dark:bg-slate-800/40 rounded-2xl border border-dashed border-slate-200 dark:border-slate-700 text-center text-xs font-medium text-slate-400 dark:text-slate-500">
                            ...
                            {:else}
                                <div class="space-y-3 max-h-[260px] overflow-y-auto pr-1">
                                    {#each selectedExpenseObj.activeVersion.subExpenses as sub, subIdx}
                                        <div class="p-4 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-100 dark:border-slate-700 relative space-y-3" transition:slide>
                                            <button
                                                type="button"
                                            ...
                                            <div class="space-y-2 border-t border-slate-100 dark:border-slate-700/50 pt-2">
                                                <div class="flex justify-between items-center">
                    ...
                    <div class="space-y-4">
                        <div class="p-4 bg-indigo-50/50 border border-indigo-100 dark:bg-indigo-950/20 dark:border-indigo-900/40 rounded-2xl space-y-2">
                            <h4 class="text-xs font-black text-indigo-950 dark:text-indigo-300 uppercase tracking-wider flex items-center gap-1">
                                <Info class="w-4 h-4 text-indigo-500" /> Funding Plan Calculator
                            </h4>
                        ...
                        {#if fundingMessage}
                            <div class="p-4 bg-emerald-50 border border-emerald-200 text-emerald-800 rounded-2xl text-[11px] leading-relaxed font-bold flex gap-2">
                        ...
                        {:else}
                            ...
                            {#if activeAssets.length === 0}
                                <div class="p-4 text-center text-xs font-medium text-slate-400">
                            ...
                            {:else}
                                ...
                                <button
                                    ...
                                    class="btn-primary w-full py-4 text-sm font-bold shadow-lg"
                                >
            ...
            <div class="p-6 bg-slate-50 dark:bg-slate-900/50 border-t border-slate-100 dark:border-slate-800 flex justify-end gap-3">
                <button onclick={() => showExpenseModal = false} class="px-6 py-3 border border-slate-200 text-slate-600 hover:bg-slate-100 rounded-2xl font-black text-xs uppercase tracking-wider">
                    Close
                </button>
                <button
                    onclick={saveExpenseChanges}
                    class="px-6 py-3 bg-indigo-600 text-white hover:bg-indigo-700 rounded-2xl font-black text-xs uppercase tracking-wider active:scale-95 transition-all shadow-sm"
                >
...
<!-- Asset Editor Modal -->
{#if showAssetModal && editingAssetObj}
    <div class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[999] flex items-center justify-center p-4" transition:fade>
        <div class="bg-white dark:bg-slate-900 w-full max-w-2xl rounded-3xl shadow-2xl border border-slate-100 dark:border-slate-800 overflow-hidden flex flex-col max-h-[90vh]">
            <div class="p-6 bg-slate-50 dark:bg-slate-900/50 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center">
                <div class="flex items-center gap-2">
                    <Layers class="w-5 h-5 text-indigo-500" />
                    <h3 class="text-lg font-black text-slate-900 dark:text-slate-100 uppercase tracking-tight">Edit Asset &amp; Sub-Assets</h3>
                </div>
                <button onclick={() => showAssetModal = false} class="text-slate-400 hover:text-slate-600 p-1">
                    <X class="w-5 h-5" />
                </button>
            </div>
            ...
            <div class="p-6 overflow-y-auto space-y-6 flex-1">
                ...
                <!-- Parent Asset Form -->
                <div class="space-y-4">
                    <h4 class="text-xs font-black uppercase text-indigo-600 tracking-wider">Asset Configuration</h4>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-1">
                            <label class="text-[10px] font-black uppercase text-slate-400 block" for="asset-name">Asset Name</label>
                            <input
                                id="asset-name"
                                type="text"
                        ...
                        <div class="space-y-1">
                            <label class="text-[10px] font-black uppercase text-slate-400 block" for="asset-rate">Expected Return (Simulated) %</label>
                            <input
                                id="asset-rate"
                                type="number"
                                step="0.01"
                                ...
                                disabled
                                class="w-full px-4 py-3 rounded-2xl border border-slate-200 bg-slate-100 text-sm font-bold outline-none text-slate-500 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-400 cursor-not-allowed"
                            />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-1">
                            <label class="text-[10px] font-black uppercase text-slate-400 block" for="asset-monthly">Monthly Deposit</label>
                            <input
                                id="asset-monthly"
                                type="number"
                        ...
                        <div class="space-y-1">
                            <label class="text-[10px] font-black uppercase text-slate-400 block" for="asset-target">Target Target value</label>
                            <input
                                id="asset-target"
                                type="text"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-1">
                            <label class="text-[10px] font-black uppercase text-slate-400 block" for="asset-start">Start Period</label>
                            <input
                                id="asset-start"
                                type="month"
                                value={toInputMonth(editingAssetObj.activeVersion.startDate)}
                                onchange={(e) => editingAssetObj.activeVersion.startDate = fromInputMonth(e.currentTarget.value)}
                                class="w-full px-4 py-3 rounded-2xl border border-slate-200 bg-white text-sm font-bold outline-none text-slate-700 focus:border-indigo-500 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-200"
                            />
                        </div>
                        <div class="space-y-1">
                            <label class="text-[10px] font-black uppercase text-slate-400 block" for="asset-end">End Period</label>
                            <input
                                id="asset-end"
                                type="month"
                                value={toInputMonth(editingAssetObj.activeVersion.endDate)}
                                onchange={(e) => editingAssetObj.activeVersion.endDate = fromInputMonth(e.currentTarget.value)}
                                class="w-full px-4 py-3 rounded-2xl border border-slate-200 bg-white text-sm font-bold outline-none text-slate-700 focus:border-indigo-500 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-200"
                            />
                        </div>
                    </div>
                ...
                <div class="space-y-4 pt-6 border-t border-slate-100 dark:border-slate-800">
                    <div class="flex items-center justify-between">
                        <h4 class="text-xs font-black uppercase text-cyan-600 tracking-wider">Sub-Asset Pockets (Funding targets)</h4>
                        <button
                    ...
                    <div class="space-y-4">
                        {#if !editingAssetObj.activeVersion.subAssets || editingAssetObj.activeVersion.subAssets.length === 0}
                            <div class="p-6 border-2 border-dashed border-slate-100 rounded-2xl text-center text-xs text-slate-400 font-medium dark:border-slate-800">
                        ...
                        {:else}
                            {#each editingAssetObj.activeVersion.subAssets as sa, idx}
                                <div class="p-4 bg-slate-50 dark:bg-slate-800/50 border dark:border-slate-750 rounded-2xl space-y-4 relative">
                                    <button
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                        <div class="space-y-1">
                                            <span class="text-[9px] font-black uppercase text-slate-400 block">Pocket Name</span>
                                            <input
                                                type="text"
                                                bind:value={sa.name}
                                                class="w-full px-3 py-2 rounded-xl border border-slate-200 bg-white text-xs font-bold outline-none text-slate-700 focus:border-indigo-500 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-200"
                                        ...
                                        <div class="space-y-1">
                                            <span class="text-[9px] font-black uppercase text-slate-400 block">Target value (€)</span>
                                            <input
                                                type="number"
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                        <div class="space-y-1">
                                            <span class="text-[9px] font-black uppercase text-slate-400 block">Monthly Contribution</span>
                                            <input
                                                type="number"
                                        ...
                                        <div class="space-y-1">
                                            <span class="text-[9px] font-black uppercase text-slate-400 block">Start Date</span>
                                            <input
                                                type="month"
                                        ...
                                        <div class="space-y-1">
                                            <span class="text-[9px] font-black uppercase text-slate-400 block">End Date</span>
                                            <input
                                                type="month"
            ...
            <div class="p-6 bg-slate-50 dark:bg-slate-900/50 border-t border-slate-100 dark:border-slate-800 flex justify-end gap-3">
                <button onclick={() => showAssetModal = false} class="px-6 py-3 border border-slate-200 text-slate-600 hover:bg-slate-100 rounded-2xl font-black text-xs uppercase tracking-wider">
                    Cancel
                </button>
                <button onclick={saveAssetChanges} class="px-6 py-3 bg-indigo-600 text-white hover:bg-indigo-700 rounded-2xl font-black text-xs uppercase tracking-wider shadow-md">
                    Save Changes
                </button>
            </div>
        </div>
