<script lang="ts">
    ...
    let previewExpenses = $state<Expense[]>([]);
    ...
    async function executeImport() {
        const toImport = previewExpenses.filter((e) => e.import_selected);
                    ...
                    expenses: toImport.map((e) => ({
                        ...
                        activeVersion: e.activeVersion
                            ? {
                                  ...
                                  amount: e.activeVersion?.amount || 0,
                                  dueDate: e.activeVersion?.dueDate || "",
                                  createdAt: e.activeVersion?.createdAt || "",
                              }
                            : undefined,
    ...
    $effect(() => {
        ...
        lines.forEach((line) => {
            ...
            const dueDate = parseDateString(parts[2]);
            ...
            <div class="p-10 flex flex-col overflow-hidden h-full">
                ...
                >
                    ...
                    <div class="lg:col-span-8 flex flex-col overflow-hidden">
                        <div class="flex items-center justify-between mb-4">
                            <label
                                class="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1"
                                >Verification List ({previewExpenses.length} detected)</label
                            >
                            <div class="flex gap-2">
                                <button
                                    onclick={() =>
                                        previewExpenses.forEach(
                                            (e) => (e.import_selected = true),
                                        )}
                                ...
                                <tbody>
                                    {#each previewExpenses as e, i}
                                        ...
                                        >
                                            ...
                                            <td class="p-4">
                                                <p
                                                    class="font-black text-slate-900 text-sm {e
                                                        .activeVersion
                                                        .amount === 0
                                                        ? 'text-rose-500'
                                                        : ''}"
                ...
                >
                    ...
                    >
                        ...
                        >
                            Verified: {previewExpenses.filter(
                                (e) => e.import_selected,
                            ).length} units
                        </p>
                    </div>
