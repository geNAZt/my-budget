...
type ExecuteRequest struct {
	...
	SecretsJson   string                 `protobuf:"bytes,4,opt,name=secrets_json,json=secretsJson,proto3" json:"secrets_json,omitempty"`
	TriggerJson   string                 `protobuf:"bytes,5,opt,name=trigger_json,json=triggerJson,proto3" json:"trigger_json,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ExecuteRequest) GetStateJson() string {
...
func (x *ExecuteRequest) GetSecretsJson() string {

	if x != nil {
		return x.SecretsJson
	}
	return ""
}

func (x *ExecuteRequest) GetTriggerJson() string {
...
const file_execution_proto_rawDesc = "" +
	...
	"\fsecrets_json\x18\x04 \x01(\tR\vsecretsJson\x12!\n" +
	"\ftrigger_json\x18\x05 \x01(\tR\vtriggerJson\"\x97\x01\n" +
